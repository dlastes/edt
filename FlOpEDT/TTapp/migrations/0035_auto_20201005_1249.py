# Generated by Django 3.0.5 on 2020-10-05 12:49
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='novisio',
            name='course_types',
            field=models.ManyToManyField(blank=True, related_name='no_visio', to='base.CourseType'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_types', models.ManyToManyField(blank=True, related_name='visio_only', to='base.CourseType')),
                ('department', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='base.Department')),
                ('groups', models.ManyToManyField(blank=True, related_name='visio_only', to='base.Group')),
