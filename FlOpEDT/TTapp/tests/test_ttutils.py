...
class TTutilsTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.edtv1 = models.EdtVersion.objects.create(department=cls.department1, week=39, an=2018, version=3)
    ...
    def test_basic_swap_version(self):   
        ...
        edt_version = models.EdtVersion.objects.get(department=self.department1, week=39, an=2018)
