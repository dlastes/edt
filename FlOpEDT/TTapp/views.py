...
def reassign_rooms(req, department, year, week, work_copy, new_work_copy=True):
    '''
    Reassign rooms of scheduled courses with work copy work_copy
    '''
    return JsonResponse(MyTTUtils.reassign_rooms(department, week, year, work_copy, new_work_copy=new_work_copy))
