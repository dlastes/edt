...
routerFetch.register(r'idtutor', views.IDTutorViewSet)
routerFetch.register(r'idtrainprog', views.IDTrainProgViewSet)
routerFetch.register(r'idmodule', views.IDModuleViewSet)
routerFetch.register(r'idcoursetype', views.IDCourseTypeViewSet)
routerFetch.register(r'idgroup', views.IDGroupViewSet)
routerFetch.register(r'idgrouptype', views.IDGroupTypeViewSet)
routerFetch.register(r'idroom', views.IDRoomViewSet)
routerFetch.register(r'idroomtype', views.IDRoomTypeViewSet)