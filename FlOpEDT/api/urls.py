...
routerBase.register(r'rooms', views.RoomFreeViewSet)
...
routerFetch.register(r'alltutors', views.AllTutorsViewSet, basename='alltutors')
...
routerRooms.register(r'rooms', views.RoomFreeViewSet)
