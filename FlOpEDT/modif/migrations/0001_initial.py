    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tutor_name', models.CharField(default=None, max_length=150, null=True)),
                ('supp_tutor_name', models.CharField(blank=True, default=None, max_length=150, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('initiator_name', models.CharField(default=None, max_length=150, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('head_name', models.CharField(default=None, max_length=150, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('semaine_old', models.PositiveSmallIntegerField(null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(53)])),
                ('an_old', models.PositiveSmallIntegerField(null=True)),
                ('tutor_name_old', models.CharField(default=None, max_length=150, null=True)),
                ('updated_at', models.DateTimeField()),
                ('initiator_name', models.CharField(default=None, max_length=150, null=True)),
                ('cours', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='modif.Cours')),
            ],
