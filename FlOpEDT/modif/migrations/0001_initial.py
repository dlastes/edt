# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-06-13 14:20
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('day', models.CharField(choices=[('m', 'm'), ('tu', 'tu'), ('w', 'w'), ('th', 'th'), ('f', 'f')], default='m', max_length=2)),
            ],
        ),
        migrations.CreateModel(
            name='Dependency',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_groups', models.ManyToManyField(blank=True, related_name='children_groups', to='modif.Group')),
            ],
        ),
        migrations.CreateModel(
            name='GroupCost',
        ...
        migrations.CreateModel(
            name='BIATOS',
            fields=[
                ('tutor_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='modif.Tutor')),
            ],
            options={
                'abstract': False,
                'verbose_name': 'user',
