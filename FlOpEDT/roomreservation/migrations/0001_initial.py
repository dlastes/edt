# Generated by Django 3.0.14 on 2022-10-19 08:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bm_x_choice', models.SmallIntegerField(choices=[(1, 'First'), (2, 'Second'), (3, 'Third'), (4, 'Fourth'), (-2, 'Ante Last'), (-1, 'Last')])),
                ('bm_day_choice', models.CharField(choices=[('m', 'monday'), ('tu', 'tuesday'), ('w', 'wednesday'), ('th', 'thursday'), ('f', 'friday'), ('sa', 'saturday'), ('su', 'sunday')], max_length=2)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reservation_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='roomreservation.RoomReservationType')),
