...
urlpatterns = [
    ...
    path('fetch_course_default_week/<str:train_prog>/<str:course_type>', views.fetch_course_default_week,
    ...
    url(r'^fetch_unavailable_rooms/(?P<year>\d+)/(?P<week>\d+)$', views.fetch_unavailable_rooms,
    ...
    path('fetch_tutor_courses/<int:year>/<int:week>/<str:tutor>', views.fetch_tutor_courses,
    ...
    path('change_user_pref/<int:year>/<int:week>/<str:username>', views.user_preferences_changes,
         name="user_pref_changes"),
    path('change_course_pref/<int:year>/<int:week>/<str:train_prog>/<str:course_type>',
