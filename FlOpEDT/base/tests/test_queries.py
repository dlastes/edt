...
class FirstDepartmentTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.edt_version_1 = models.EdtVersion.objects.create(week=1, an=2018, version=0)
        cls.edt_version_2 = models.EdtVersion.objects.create(week=2, an=2018, version=0)
        cls.regen1 = models.Regen(week=1, an=2018)
        cls.regen2 = models.Regen(week=1, an=2018)
...
class EdtVersionTestCase(TestCase):
    def setUp(self):
        ...
        self.edt2 = models.EdtVersion.objects.create(department=self.d1, week=40, an=2018, version=2)
    ...
    def test_get_version_multiple_objects_exist(self):
        self.edt3 = models.EdtVersion.objects.create(department=self.d1, week=40, an=2018, version=2)
...
class ScheduledCourseTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.c1 = models.Course.objects.create(group=cls.g1, week=39, an=2018, type=cls.ct1, module=cls.m1)
